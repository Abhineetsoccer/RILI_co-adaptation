...
parser.add_argument('--num_eps', type=int, default=25000)
...
for i_episode in range(1, args.num_eps+1):
    ...
    while not done:
        ...
        next_states, rewards, done, _ = env.step([action_agent1, action_agent2])
        reward1, reward2 = rewards[0], rewards[1]
        next_state1, next_state2 = next_states[0], next_states[1]
